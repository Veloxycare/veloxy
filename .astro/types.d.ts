...
"driver-certifications-to-acquire-within-60-days-of-driving-for-veloxy-care-ride.mdoc": {
	id: "driver-certifications-to-acquire-within-60-days-of-driving-for-veloxy-care-ride.mdoc";
  slug: "driver-certifications-to-acquire-within-60-days-of-driving-for-veloxy-care-ride";
  body: string;
  collection: "legaldocuments";
  data: any
} & { render(): Render[".mdoc"] };
